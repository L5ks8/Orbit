                                ...
                                <div className="flex-1 min-w-0 ">
                                  <div className="block max-w-[88%] text-[15px] leading-[1.65] text-neutral-100 text-pretty break-words">
                                    ...
                                    <div className="mt-2.5">
                                      <p className="my-1">
                                        Hey there! I can help you build out your
                                        Discord server. What's the main theme or
                                        purpose of your server, like what game
                                        or community is it for? Or just say "go
                                        for it" and I'll set one up with the
                                        usual stuff.
                                      </p>
                                    </div>
                                  </div>
                        ...
                        <div className="flex-shrink-0 p-2 sm:p-4 border-t border-neutral-800">
                          <div className="w-full">
                            ...
                            <div className="mt-2 text-center text-[11px] text-neutral-500">
                              You're chatting with Peak, an AI assistant. AI can
                              make mistakes ÔÇö review changes before applying.
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2 min-w-0 flex-1">
                              ...
                              <span className="hidden xl:inline text-[13px] tabular-nums truncate">
                                ...
                                <span className="text-neutral-600"> ┬À </span>
                                <span className="text-neutral-200 font-semibold">
                                  6
                                </span>
                                <span className="text-neutral-600">
