...
export default function EmbedBuilder({ setSidebarOpen, sidebarOpen }) {
  ...
  return (
    <div style={{ padding: '32px', maxWidth: '1200px', margin: '0 auto', animation: 'fadeIn 0.2s ease-out' }}>
      <h1 style={{ fontSize: '28px', fontWeight: 700, color: '#f2f3f5', marginBottom: '32px' }}>Nachrichten</h1>
      
      <div style={{ marginBottom: '32px' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#f2f3f5', marginBottom: '12px' }}>Nachrichten Suchen</h3>
        <input 
          type="text" 
          placeholder="Nach einer Nachricht suchen..." 
          value={search}
      ...
      <div>
        <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#f2f3f5', marginBottom: '16px' }}>Nachrichten</h3>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '16px' }}>
          ...
          {loading ? (
            <div style={{ color: '#949ba4', display: 'flex', alignItems: 'center' }}>Lade Nachrichten...</div>
          ) : (
            filteredEmbeds.map(emb => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <span style={{ color: '#f2f3f5', fontWeight: 500 }}>{emb.name || 'Unbenannte Nachricht'}</span>
                </div>
