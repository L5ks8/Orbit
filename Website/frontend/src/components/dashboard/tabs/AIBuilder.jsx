                        ...
                        <div className="block max-w-[88%] text-[15px] leading-[1.65] text-neutral-100 text-pretty break-words">
                          ...
                          <div className="mt-2.5">
                            <p className="my-1">
                              ...
                              server, like what game or community is it for? Or
                              just say "go for it" and I'll set one up with the
                              usual stuff.
                            </p>
                          </div>
                        </div>
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    ...
                    <span className="hidden xl:inline text-[13px] tabular-nums truncate">
                      <span className="text-neutral-200 font-semibold">28</span>
                      <span className="text-neutral-600"> channels · </span>
                      <span className="text-neutral-200 font-semibold">17</span>
                      <span className="text-neutral-600"> roles</span>
                      <span className="text-neutral-600"> · </span>
                      <span className="text-neutral-200 font-semibold">6</span>
