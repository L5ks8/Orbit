...
export default function VerificationSettings({ guildId: propGuildId, config, channels, roles, onSave, saving, onReset }) {
  ...
  const roleOptions = (roles || []).map(r => ({ value: r.id, label: r.name || 'Unknown Role', color: r.color }));
