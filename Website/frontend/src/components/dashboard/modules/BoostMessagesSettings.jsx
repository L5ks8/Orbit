          ...
          <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_14px_34px_-20px_rgba(0,0,0,0.9)]">
            <div className="flex items-center justify-between gap-4 px-5 py-4 border-b border-neutral-800">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <span className="text-sm font-semibold text-white truncate">Message Builder</span>
              </div>
            </div>
            
            <div className="px-5 pb-5 pt-5 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-6 h-full">
          ...
          <div className="bg-neutral-900/50 border border-neutral-800/50 rounded-xl p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-neutral-800/50 px-3 py-2 rounded-lg text-xs flex justify-between items-center"><code className="text-pink-400 font-semibold">{'{user}'}</code> <span className="text-neutral-500">@User</span></div>
              <div className="bg-neutral-800/50 px-3 py-2 rounded-lg text-xs flex justify-between items-center"><code className="text-pink-400 font-semibold">{'{server}'}</code> <span className="text-neutral-500">Server Name</span></div>
              <div className="bg-neutral-800/50 px-3 py-2 rounded-lg text-xs flex justify-between items-center"><code className="text-pink-400 font-semibold">{'{count}'}</code> <span className="text-neutral-500">Boost Count</span></div>
              <div className="bg-neutral-800/50 px-3 py-2 rounded-lg text-xs flex justify-between items-center"><code className="text-pink-400 font-semibold">{'{id}'}</code> <span className="text-neutral-500">User ID</span></div>
            </div>
          </div>
        </div>
      </div>
