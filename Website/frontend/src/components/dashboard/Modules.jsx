...
export const modulesList = [
    ...
    { id: 'welcome', category: 'Engagement', name: 'Welcome Messages', desc: 'Greet new users with custom text and image cards.', iconColor: 'rgba(59, 130, 246, 0.2)', icon: <path d="M12 15l-2 5l9-5l-5-5L12 15z M2 15l9-5-2-5L2 15z" /> },
    { id: 'level', category: 'Engagement', name: 'Leveling System', desc: 'Reward active members with XP and roles.', iconColor: 'rgba(16, 185, 129, 0.2)', icon: <path d="M14 22v-4a2 2 0 1 0-4 0v4M12 14v4M12 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM4.93 4.93l1.41 1.41M19.07 19.07l-1.41-1.41M14.83 9.17l2.83-2.83M6.34 17.66l-2.83 2.83" /> },
  ...
  return (
    <React.Fragment>
      ...
      <div style={{ 
        ...
        <div style={{ padding: '24px', borderBottom: '1px solid rgba(255,255,255,0.05)', background: '#09090b' }}>
          <button 
                  ...
                  return (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ color: isActive ? '#5865F2' : '#949ba4', transition: 'color 0.2s' }}>
      ...
      {/* Right Content */}
      <div style={{ flexGrow: 1, overflowY: 'auto', background: '#111214' }}>
         {renderModuleContent()}
      </div>
      </div>
    </React.Fragment>
