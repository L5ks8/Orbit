    ...
    <div className="moderation-container w-full h-full">
      <main className="p-4 lg:p-6 xl:p-8 max-w-[1200px] mx-auto">
        <div>
          ...
          <div className="mt-6">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr,340px] gap-4 lg:items-stretch min-w-0">
                    ...
                    <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_14px_34px_-20px_rgba(0,0,0,0.9)] ">
                      ...
                      >
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-1.5 max-w-md mx-auto mb-4">
                          <span className="text-[11px] px-2 py-1 rounded-md bg-neutral-800/70 text-neutral-400 border border-neutral-800">
                            Hate speech
                          </span>
                          <span className="text-[11px] px-2 py-1 rounded-md bg-neutral-800/70 text-neutral-400 border border-neutral-800">
                            Harassment
                ...
                <div data-tour="content-filter" className="scroll-mt-24">
                  <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_14px_34px_-20px_rgba(0,0,0,0.9)] ">
                    ...
                    <div className="p-4 sm:p-5 space-y-5">
                      <div
                        data-tour="moderation-filter-level"
                      ...
                      >
                        <div>
                          ...
                          >
                            <button
                              type="button"
                              className="rounded-xl border px-2 py-3 flex flex-col items-center gap-2 transition-[color,background-color,border-color,scale] duration-150 active:scale-[0.96] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/15 border-amber-500/50 bg-amber-500/10"
                            >
                              <span
                              ...
                              >
                                <span
                                  className="w-1 rounded-full transition-colors bg-amber-400"
                                  style={{ height: "7px" }}
                                ></span>
                                <span
                                  className="w-1 rounded-full transition-colors bg-neutral-700"
                                  style={{ height: "10px" }}
                                ></span>
                                <span
                                  className="w-1 rounded-full transition-colors bg-neutral-700"
                            ...
                            <button
                              type="button"
                              className="rounded-xl border px-2 py-3 flex flex-col items-center gap-2 transition-[color,background-color,border-color,scale] duration-150 active:scale-[0.96] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/15 border-neutral-800 bg-neutral-800/40 hover:border-neutral-700"
                            >
                              <span
                                className="flex items-end gap-[3px] h-4"
                                aria-hidden="true"
                              >
                                <span
                                  className="w-1 rounded-full transition-colors bg-neutral-500"
                                  style={{ height: "7px" }}
                                ></span>
                                <span
                                  className="w-1 rounded-full transition-colors bg-neutral-500"
                              ...
                              <span className="text-[13px] font-medium leading-none text-neutral-400">
                                Moderate
                              </span>
                            </button>
                            <button
                      ...
                      <div
                        data-tour="moderation-content-action"
                        className="scroll-mt-24"
                      >
                        <div>
                          <div className="flex items-baseline justify-between gap-3 mb-2">
                      ...
                      <div>
                        <button
                          type="button"
                          className="flex items-center justify-between w-full min-h-[44px] py-2 text-left group rounded-lg transition-[scale] duration-150 active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20"
                        >
                        ...
                        <div className="space-y-2.5">
                          <div className="flex gap-2">
                            <input
                              ...
                              value=""
                            />
                            <button className="h-10 px-4 bg-neutral-700 text-neutral-200 text-sm font-medium rounded-xl hover:bg-neutral-600 transition-[transform,background-color,color] duration-150 ease-out active:scale-[0.96] disabled:active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 flex-shrink-0">
                              Add
                            </button>
                          </div>
                        </div>
                    ...
                    <div className="p-4 sm:p-5 space-y-5">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <button
                            type="button"
                            className="rounded-xl border px-2 py-3 flex flex-col items-center gap-2 transition-[color,background-color,border-color,scale] duration-150 active:scale-[0.96] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/15 border-blue-500/50 bg-blue-500/10"
                          >
                            <span
                              className="flex items-end gap-[3px] h-4"
                              aria-hidden="true"
                            >
                              <span
                                className="w-1 rounded-full transition-colors bg-blue-400"
                                style={{ height: "7px" }}
                              ></span>
                              <span
                                className="w-1 rounded-full transition-colors bg-blue-400"
                        ...
                        <div>
                          ...
                          <div className="flex items-center h-10 bg-neutral-800 border border-neutral-700 hover:border-neutral-600 rounded-xl transition-[border-color,box-shadow,opacity] duration-150 ease-out focus-within:border-neutral-600 focus-within:ring-2 focus-within:ring-white/10 ">
                            <input
                              ...
                              value="5"
                            />
                            <span className="pr-3 text-xs font-medium text-neutral-500 flex-shrink-0 select-none">
                              msgs
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="divide-y divide-neutral-800/60">
                      <div className="flex items-center justify-between gap-3 px-4 sm:px-5 py-3 ">
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-neutral-600 mt-0.5 leading-relaxed">
                            Removes discord.gg / discord.com invite links
                          </p>
                        </div>
                      ...
                      <div className="flex items-center justify-between gap-3 px-4 sm:px-5 py-3 ">
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-neutral-600 mt-0.5 leading-relaxed">
                            Let Discord CDN images &amp; attachments through
                          </p>
                        </div>
                        <div className="flex-shrink-0">
                          <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center justify-between gap-3 px-4 sm:px-5 py-3 ">
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-neutral-600 mt-0.5 leading-relaxed">
                            Let Tenor &amp; Giphy GIF links through
                          </p>
                        </div>
                        <div className="flex-shrink-0">
                          <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-start gap-3 px-4 sm:px-5 py-3 hover:bg-neutral-800/20 transition-[background-color] duration-150 ease-out">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="px-1.5 py-0.5 rounded-[4px] text-[9px] font-bold uppercase tracking-wider tabular-nums bg-neutral-800 text-neutral-400 border border-neutral-700">
                                untimeout
                              </span>
                            </div>
                            <p className="text-xs text-neutral-500 mt-1 truncate">
                              Removed via timeout quick-action
                            </p>
                          </div>
                        ...
                        <div className="flex items-start gap-3 px-4 sm:px-5 py-3 hover:bg-neutral-800/20 transition-[background-color] duration-150 ease-out">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="px-1.5 py-0.5 rounded-[4px] text-[9px] font-bold uppercase tracking-wider tabular-nums bg-orange-500/10 text-orange-400 border border-orange-500/20">
                                timeout
                              </span>
                            </div>
                            <p className="text-xs text-neutral-500 mt-1 truncate">
            ...
            <div
              data-tour="moderation-actions"
              className="mt-5 pt-5 border-t border-neutral-800 space-y-4 scroll-mt-24"
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div
                  data-tour="moderation-log"
                  className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_14px_34px_-20px_rgba(0,0,0,0.9)] scroll-mt-24"
                >
                  <div className="flex items-center gap-2 px-4 sm:px-5 py-3 border-b border-neutral-800">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_14px_34px_-20px_rgba(0,0,0,0.9)]">
                ...
                <div className="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-neutral-600 leading-relaxed text-pretty">
                      Warns, bans, kicks, timeouts &amp; unbans
                    </p>
                  </div>
                </div>
