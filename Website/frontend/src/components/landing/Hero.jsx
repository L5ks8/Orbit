  ...
  return (
    <section className="lp-hero fade-in-up delay-1">
      ...
      <div className="lp-hero-actions">
        <a href="https://discord.com/oauth2/authorize?client_id=1480221897131299037&permissions=564430072179839&scope=bot+applications.commands" className="lp-btn-primary btn-animated" target="_blank" rel="noopener noreferrer">
