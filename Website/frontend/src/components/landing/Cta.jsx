...
export default function Cta() {
  return (
    <section className="lp-cta-section">
      <div className="lp-section-glow-line"></div>
      <h2 className="lp-cta-title reveal">Ready to upgrade your server?</h2>
      <p className="lp-cta-sub reveal">Add Orbit in seconds. No credit card, no setup fees. Completely free.</p>
      <div className="lp-hero-actions reveal" style={{ marginTop: '40px' }}>
        <a href="https://discord.com/oauth2/authorize?client_id=1480221897131299037&permissions=564430072179831&scope=bot+applications.commands" className="lp-btn-primary btn-animated" target="_blank" rel="noopener noreferrer">
          ...
          Get Orbit &mdash; It's Free
        </a>
        <button className="lp-btn-secondary btn-animated">
          Open Dashboard
