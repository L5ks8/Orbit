    ...
    <div>
      ...
      <div className="rounded-xl overflow-hidden border border-neutral-700/30">
        <div className="bg-[#2f3136] px-4 py-2 flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 text-neutral-400">
        ...
        <div className="bg-[#313338] px-4 pt-3 pb-4" style={{ fontFamily: '"gg sans", "Helvetica Neue", Helvetica, Arial, sans-serif' }}>
          
          {/* System Message */}
          {mode !== 'image' && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              {cardTitle === 'WELCOME' ? (
                <svg style={{ width: '18px', height: '18px', color: '#23a559' }} viewBox="0 0 24 24">
                  <path fill="currentColor" d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm2.3-13.7a1 1 0 0 0-1.6 1.4l1.3 1.3H9a1 1 0 1 0 0 2h5l-1.3 1.3a1 1 0 0 0 1.4 1.4l3-3a1 1 0 0 0 0-1.4l-3-3Z" />
                </svg>
              ) : (
                <svg style={{ width: '18px', height: '18px', color: '#da373c' }} viewBox="0 0 24 24">
                  <path fill="currentColor" d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm-2.3-13.7a1 1 0 0 1 1.6 1.4l-1.3 1.3H15a1 1 0 1 1 0 2h-5l1.3 1.3a1 1 0 0 1-1.4 1.4l-3-3a1 1 0 0 1 0-1.4l3-3Z" />
                </svg>
              )}
              <span style={{ color: '#DBDEE1', fontSize: '15px' }}>
                <span style={{ fontWeight: '500', color: '#FFF', cursor: 'pointer' }}>@User</span>
                {" "}
                {cardTitle === 'WELCOME' ? 'joined the server.' : 'left the server.'}
              </span>
            </div>
          )}
