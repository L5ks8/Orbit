...
@verify_group.command(name="user", description="Manually verify a member and grant them the server verified role.")
...
@user_cmd.error
async def user_error(ctx: commands.Context, error):
