...
from Commands.Role._group import all_group
...
@all_group.command(name="roles", aliases=["allroles"], description="Displays all roles on the server with interactive pagination.")
...
class AllRolesFallback(commands.Cog):
    ...
    @commands.command(name="allroles", hidden=True)
