...
from Commands.Info._group import server_group
...
@server_group.command(name="info", description="Displays complete server statistics and overview (`/server info`).")
...
class ServerInfoPrefixFallback(commands.Cog):
    ...
    @commands.command(name="server info", aliases=["serverinfo", "infoserver"], hidden=True)
