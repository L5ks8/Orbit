...
from Commands.Info._group import info_group
...
@info_group.command(name="user", description="Shows detailed member statistics, timestamps, and roles (`/info user`).")
...
class UserInfoPrefixFallback(commands.Cog):
    ...
    @commands.command(name="info user", aliases=["infouser", "userinfo"], hidden=True)
