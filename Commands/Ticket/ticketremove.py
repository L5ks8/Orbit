...
@ticket_group.command(name="remove", description="Remove a member's access from the current support ticket channel.")
...
@remove_cmd.error
async def remove_error(ctx: commands.Context, error):
